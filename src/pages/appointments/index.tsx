...
export function AppointmentListPage(props: AppointmentListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getAppointments({
        relations: ['healthcare_provider', 'medical_staff'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['appointment_info.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'appointment_info', header: 'Appointment Info', accessorKey: 'appointment_info' },
    hasAccess('healthcare_provider', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            ...
            >
              {record.healthcare_provider?.profile_info}
            </Link>
          ),
        }
      : null,
    hasAccess('medical_staff', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            ...
            >
              {record.medical_staff?.profile_info}
            </Link>
          ),
        }
      : null,
