...
export function PatientListPage(props: PatientListPageProps) {
  ...
  const fetcher = useCallback(
    async () =>
      getPatients({
        relations: ['medical_staff', 'insurance_provider'],
        limit: params.pageSize,
        offset: params.pageNumber * params.pageSize,
        searchTerm: params.searchTerm,
        order: params.order,
        searchTermKeys: ['patient_info.contains'],
        ...(params.filters || {}),
      }),
  ...
  const columns: ColumnType[] = [
    { id: 'patient_info', header: 'Patient Info', accessorKey: 'patient_info' },
    ...
    hasAccess('insurance_provider', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)
      ? {
          ...
          cell: ({ row: { original: record } }: any) => (
            ...
            >
              {record.insurance_provider?.insurance_info}
            </Link>
          ),
        }
      : null,
